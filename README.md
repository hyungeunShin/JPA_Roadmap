...
### 2. 스프링부트와 JPA 활용1 - 웹 애플리케이션 개발([jpa-shop](https://github.com/hyungeunShin/JPA_Roadmap/tree/master/jpa-shop))

### 3. 스프링부트와 JPA 활용2 - API 개발과 성능 최적화([jpa-shop](https://github.com/hyungeunShin/JPA_Roadmap/tree/master/jpa-shop))
