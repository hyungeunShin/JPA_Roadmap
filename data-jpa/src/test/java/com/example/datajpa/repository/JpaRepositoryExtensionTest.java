    ...
    void customRepository() {
        ...
        사용자 정의 구현 클래스
            ...
            - Impl 대신 다른 이름으로 변경하고 싶으면?
                - XML 설정
                    <repositories base-package="com.example.datajpa.repository" repository-impl-postfix="Impl" />
                - JavaConfig 설정
                    @EnableJpaRepositories(basePackages = "com.example.datajpa.repository", repositoryImplementationPostfix = "Impl")
