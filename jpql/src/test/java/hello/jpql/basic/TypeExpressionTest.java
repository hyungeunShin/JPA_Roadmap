...
class TypeExpressionTest {
    ...
    JPQL 타입 표현
        ...
        • Boolean: TRUE, FALSE
        • ENUM: hello.jpql.domain.MemberType.Admin (패키지명 포함)
    ...
    */
    ...
    void test1() {
        ...
        String query = "select m.name, 'HELLO', TRUE from Member m where m.type = hello.jpql.domain.MemberType.USER";
