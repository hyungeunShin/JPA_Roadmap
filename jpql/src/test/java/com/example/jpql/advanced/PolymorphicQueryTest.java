...
import com.example.jpql.domain.Album;
import com.example.jpql.domain.Book;
import com.example.jpql.domain.Item;
import com.example.jpql.domain.Movie;
...
class PolymorphicQueryTest {
    ...
    void test1() {
        ...
        resultList.forEach(i -> log.info("i : {}", i));
    }
